...
public class TriggersConfigurationDBDataSourceImpl implements TriggersConfigurationDBDataSource {
  ...
  public TriggersConfigurationDBDataSourceImpl(Context context,
...
/*
  ...
  public BusinessObject<ConfigurationInfoResult> obtainConfigData() {
    ...
    try {
      ConfigurationInfoResult configurationInfoResult =
          configInfoResultReader.readConfigInfo(realm);
  ...
  @Override public BusinessObject<Object> removeLocalStorage() {
    Realm realm = realmDefaultInstance.createRealmInstance(context);
  ...
  @Override public BusinessObject<List<String>> retrieveCrmUserTags() {
    Realm realm = realmDefaultInstance.createRealmInstance(context);

    try {
      ConfigurationInfoResult configurationInfoResult =
          configInfoResultReader.readConfigInfo(realm);
      return new BusinessObject<>(configurationInfoResult.getCrmCustomFields().getTags(),
  ...
  @Override public BusinessObject<List<String>> retrieveCrmDeviceTags() {
    Realm realm = realmDefaultInstance.createRealmInstance(context);

    try {
      ConfigurationInfoResult configurationInfoResult =
          configInfoResultReader.readConfigInfo(realm);
      return new BusinessObject<>(configurationInfoResult.getDeviceCustomFields().getTags(),
          BusinessError.createOKInstance());
    } catch (Exception re) {
      return new BusinessObject(null, BusinessError.createKOInstance(re.getMessage()));
    } finally {
  ...
  @Override public BusinessObject<List<String>> retrieveCrmDeviceBusinessUnits() {
    Realm realm = realmDefaultInstance.createRealmInstance(context);
    ...
    try {
      ...
      return new BusinessObject<>(
          configurationInfoResult.getDeviceCustomFields().getBusinessUnits(),
          BusinessError.createOKInstance());
    } catch (Exception re) {
      return new BusinessObject(null, BusinessError.createKOInstance(re.getMessage()));
    } finally {
  ...
  @Override public BusinessObject<List<CustomField>> retrieveCrmUserCustomFields() {
    Realm realm = realmDefaultInstance.createRealmInstance(context);

    try {
      ConfigurationInfoResult configurationInfoResult =
          configInfoResultReader.readConfigInfo(realm);
      return new BusinessObject<>(configurationInfoResult.getCrmCustomFields().getCustomFieldList(),
          BusinessError.createOKInstance());
    } catch (Exception re) {
      return new BusinessObject(null, BusinessError.createKOInstance(re.getMessage()));
    } finally {
  ...
  @Override public BusinessObject<List<String>> retrieveCrmUserBusinessUnits() {
    Realm realm = realmDefaultInstance.createRealmInstance(context);

    try {
      ConfigurationInfoResult configurationInfoResult =
          configInfoResultReader.readConfigInfo(realm);
      return new BusinessObject<>(configurationInfoResult.getCrmCustomFields().getBusinessUnits(),
          BusinessError.createOKInstance());
    } catch (Exception re) {
      return new BusinessObject(null, BusinessError.createKOInstance(re.getMessage()));
    } finally {
  ...
  @Override public void saveUserBusinessUnits(List<String> userBusinessUnits) {
    Realm realm = realmDefaultInstance.createRealmInstance(context);
  ...
  @Override public void saveCrmUserTags(List<String> userTagList) {
    Realm realm = realmDefaultInstance.createRealmInstance(context);
  ...
  @Override public void saveUserCustomFields(List<CustomField> customFieldList) {
    Realm realm = realmDefaultInstance.createRealmInstance(context);
  ...
  @Override public void saveCrmDeviceUserTags(List<String> deviceTags) {
    Realm realm = realmDefaultInstance.createRealmInstance(context);
  ...
  @Override public void saveCrmDeviceBusinessUnits(List<String> deviceBusinessUnits) {
    Realm realm = realmDefaultInstance.createRealmInstance(context);
