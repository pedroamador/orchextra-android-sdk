...
public class OrchextraGenericResponseMapperTest {
  ...
  @Test public void testCreateBusinessErrorOk() throws Exception {
  ...
  @Test public void testOnExceptionOk() throws Exception {
    ApiGenericExceptionResponse response =
        new ApiGenericExceptionResponse(new NullPointerException("Null Pointer Exception"));
