...
@Module public class NotificationsModule {
  ...
  @Provides @Singleton ForegroundNotificationBuilderImpl provideForegroundNotificationBuilderImp(
      ContextProvider contextProvider) {
    return new ForegroundNotificationBuilderImpl(contextProvider);
  }

  @Provides @Singleton NotificationBehavior provideNotificationBehavior(
  ...
  @Provides @Singleton AndroidNotificationBuilder provideAndroidNotificationBuilder(
      ContextProvider contextProvider) {
    return new AndroidNotificationBuilder(contextProvider.getApplicationContext());
  }

  @Provides @Singleton AndroidNotificationMapper provideAndroidNotificationMapper() {
    return new AndroidNotificationMapper();
  }

  @Provides @Singleton BackgroundNotificationBuilderImpl provideBackgroundNotificationBuilderImp(
      AndroidNotificationBuilder androidNotificationBuilder,
      AndroidBasicActionMapper androidBasicActionMapper) {
    return new BackgroundNotificationBuilderImpl(androidNotificationBuilder,
        androidBasicActionMapper);
  }

  @Provides @Singleton NotificationDispatcher provideNotificationDispatcherImpl(
