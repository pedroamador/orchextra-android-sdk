...
@Module public class ImageRecognitionModule {
  /*
      @Provides
      @Singleton
  ...
  */
  @Singleton @Provides ScannerResultMapper provideScannerResultMapper() {
    return new ScannerResultMapper();
  }

  @Singleton @Provides ImageRecognitionManager provideImageRecognitionManager(
      ImageRecognitionController imageRecognitionController, ContextProvider contextProvider,
      OrchextraLogger orchextraLogger) {
    ImageRecognitionManager imageRecognitionManagerReturn =
        new ImageRecognitionManagerImpl(imageRecognitionController, contextProvider,
            orchextraLogger);
    return imageRecognitionManagerReturn;
  }

  @Singleton @Provides ImageRecognitionController provideImageImageRecognitionController(
      InteractorInvoker interactorInvoker, @GetIrCredentialsInteractorExecution
      Provider<InteractorExecution> getImageRecognitionCredentialsInteractorExecutionProvider,
      ...
      ScannerResultMapper scannerResultMapper, OrchextraLogger orchextraLogger) {
