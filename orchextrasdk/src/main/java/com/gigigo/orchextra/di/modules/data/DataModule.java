...
public class DataModule {
  ...
  @Provides @Singleton AuthenticationDataSource provideAuthenticationDataSource(
      OrchextraApiService orchextraApiService, Provider<NetworkExecutor> serviceExecutorProvider,
  ...
  @Provides @Singleton StatsDataSourceImp provideStatsDataSource(
      OrchextraApiService orchextraApiService, Provider<NetworkExecutor> serviceExecutorProvider) {
  ...
  @Provides @Singleton SessionDBDataSource provideSessionDBDataSource(
      ContextProvider contextProvider, AndroidDevice androidDevice, SessionUpdater sessionUpdater,
    ...
    return new SessionDBDataSourceImpl(contextProvider.getApplicationContext(),
        androidDevice.getAndroidDeviceInfo(), sessionUpdater, sessionReader, realmDefaultInstance,
        crmCustomFieldsReader, deviceCustomFieldsReader);
  }

  @Provides @Singleton TriggersConfigurationDBDataSource provideConfigDBDataSource(
      ContextProvider contextProvider, ConfigInfoResultUpdater configInfoResultUpdater,
  ...
  @Provides @Singleton ProximityDBDataSource provideBeaconsDBDataSource(
      ContextProvider contextProvider, ProximityEventsUpdater proximityEventsUpdater,
      RegionEventsReader regionEventsReader, RealmDefaultInstance realmDefaultInstance,
  ...
  @Provides @Singleton GeofenceDBDataSource provideGeofenceDBDataSource(
      ContextProvider contextProvider, GeofenceEventsUpdater geofenceEventsUpdater,
      GeofenceEventsReader geofenceEventsReader, RealmDefaultInstance realmDefaultInstance) {
  ...
  @Provides @Singleton OrchextraStatusDBDataSource provideOrchextraStatusDBDataSource(
      ContextProvider contextProvider, OrchextraStatusUpdater orchextraStatusUpdater,
  ...
  @Provides @Singleton AndroidInstanceIdProvider provideAndroidInstanceIdProvider() {
    return new AndroidInstanceIdProvider();
  }

  @Provides @Singleton DeviceDetailsProvider provideDeviceDetailsProvider(
      ContextProvider contextProvider, AndroidInstanceIdProvider androidInstanceIdProvider) {

    String androidInstanceId =
        androidInstanceIdProvider.provideAndroidInstanceId(contextProvider.getApplicationContext());
    return new DeviceDetailsProviderImpl(contextProvider.getApplicationContext(),
        androidInstanceId);
  }

  @Provides @Singleton RealmDefaultInstance provideRealmDefaultInstance() {
