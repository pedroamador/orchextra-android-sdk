...
public class AndroidSdkVersionAppInfo {
  ...
  public SdkVersionAppInfo getAndroidAppInfo() {
    ...
    sdkVersionAppInfo.setAppVersion(
        String.valueOf(OrchextraManager.getApplicationVersion())); //BuildConfig.VERSION_NAME);
    sdkVersionAppInfo.setBuildVersion(
        String.valueOf(OrchextraManager.getApplicationVersionCode()));//BuildConfig.VERSION_CODE
