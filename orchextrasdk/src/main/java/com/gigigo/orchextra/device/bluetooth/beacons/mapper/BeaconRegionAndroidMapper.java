...
//TODO LIB_CRUNCH altBeacon ini
        ...
        OrchextraRegion orchextraRegion = new OrchextraRegion(region.getUniqueId(),
                ...
                true);
//TODO LIB_CRUNCH altBeacon end
        return orchextraRegion;
    }

    //TODO LIB_CRUNCH altBeacon ini
    @Override
    public Region modelToExternalClass(OrchextraRegion model) {
    ...
    //TODO LIB_CRUNCH altBeacon
    @Override
    public List<Region> modelListToExternalClassList(List<OrchextraRegion> controlList) {
    ...
    //TODO LIB_CRUNCH altBeacon
    @Override
    public List<OrchextraRegion> externalClassListToModelList(List<Region> controlList) {
