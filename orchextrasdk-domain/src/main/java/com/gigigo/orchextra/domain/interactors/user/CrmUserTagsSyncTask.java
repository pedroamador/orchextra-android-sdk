...
public class CrmUserTagsSyncTask {
  ...
  public List<String> retrieveCrmUserBusinessUnits() {
    BusinessObject<List<String>> boCrmUserBusinessUnits =
        crmUserService.retrieveCrmUserBusinessUnits();
  ...
  public List<CustomField> retrieveCrmUserCustomFields() {
    BusinessObject<List<CustomField>> boCrmUserCustomFields =
        crmUserService.retrieveCrmUserCustomFields();
